...
import { postResultsForChangeEntireBlockSchema } from '@models';
...
export async function POST(req: NextRequest) {
  ...
  const args = postResultsForChangeEntireBlockSchema.safeParse(
    await req.json()
  );
  ...
  await timeService.addChoiceEntireBlock(args.data, wedstrijdId);
